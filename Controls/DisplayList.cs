...
namespace ImmersiveGaming
{
    ...
    {
        List<Tuple<Screen, Display>> _monitors = new List<Tuple<Screen, Display>>();
        ...
        public DisplayList()
        {
            ...
            foreach (var screen in Screen.AllScreens)
            {
                ...
                _monitors.Add(Tuple.Create(screen, monitor));
        ...
        public virtual IEnumerable<Display> Monitors
        {
            get
            {
                return _monitors.Select(a => a.Item2);
            }
        }

        public Display ScreenFromBounds(Rectangle bounds)
        {
            return _monitors.Where(a=>a.Item1.Bounds == bounds).Select(a=>a.Item2).FirstOrDefault();
        }
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            foreach (var item in _monitors)
            {
                ...
                monitor.Bounds = new Rectangle(
                    ...
                    (int)(screenBounds.Right * scale) - (int)(screenBounds.Left * scale),
                    (int)(screenBounds.Bottom * scale) - (int)(screenBounds.Top * scale)
                    );
            }
        }
    }
